package com.tern.drap.bottomdragview.view;
...
import com.tern.drap.bottomdragview.R;

/**
 * Created by zhangtengyuan on 16/1/11.
 */
public class BottomDragView extends ViewGroup {
    ...
    public BottomDragView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public BottomDragView(Context context, AttributeSet attrs, int defStyle) {
